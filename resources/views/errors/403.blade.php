<head>
    <title>QuickTrade | Error 403</title>
    ...
    <link rel="stylesheet" href="{{ asset('build/assets/css/403.css') }}">
</head>
...
<div id="sign-wrapper">
  ...
  <section id="sign-body">
    <div id="copy-container">
      ...
      <p><strong>Error 403: Prohibido</strong>. No tienes acceso a este recurso.</p>
    </div>
    <div id="circle-container">
      <svg version="1.1" viewBox="0 0 500 500" preserveAspectRatio="xMinYMin meet">
        ...
        <circle cx="250" cy="250" r="200" stroke-width="40px" stroke="rgb(22, 101, 52)" fill="url(#image)"/>
        <line x1="100" y1="100" x2="400" y2="400" stroke-width="40px" stroke="rgb(22, 101, 52)"/>
      </svg>
    </div>
  </section>
</div>
