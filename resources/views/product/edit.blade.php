    ...
    <x-app-layout>
      ...
      <x-slot name="header">
          <h2 class="font-semibold text-xl text-gray-800 leading-tight">
              QuickTrade | ¡¡Edita El Tipo De Producto!!
          </h2>
      </x-slot>
                ...
                <table align="center" class="shadow-xl bg-white sm:rounded-lg">
                    <td >
                        <div class="form-container shadow-xl sm:rounded-lg">
                            <div class="form">
                                ...
                                <input value="{{ $product->name }}" name="name" type="text" class="input" nullable autofocus>
                                <textarea name="description" rows="10" cols="30" id="message" name="description" class="textarea" nullable>
                                  {{ $product->description }}
                                </textarea>
                    ...
                    <td style="padding-right: 50px">
                        ...
                        <div class="container m-4" > 
                            ...
                            <input id="file" type="file" value="{{ $product->image }}" name="image" accept="image/*" required> 
                            @error('image')
