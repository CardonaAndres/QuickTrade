  ...
  <div class="container pt-3 pl-5 pr-5">
    ...
    <div class="card items-center shadow-xl">
        <div class="card-body">
            ...
            <x-label class="font-semibold text-xl text-gray-800 leading-tight pb-4">¿Qué Producto Desea Públicar?</x-label>

             <p><x-validation-errors class="mb-4" /></p>

            <form action="{{ route('producer_detail.store') }}" method="POST">
              @csrf
